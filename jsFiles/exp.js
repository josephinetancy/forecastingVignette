...
/* 
    ...
    const preSpin = {
        ...
        data: {ev: jsPsych.timelineVariable('ev'), sd: jsPsych.timelineVariable('sd'), reliability: jsPsych.timelineVariable('reliability'), jsPsych.timelineVariable('uniformity'), jsPsych.timelineVariable('cardinality'), jsPsych.timelineVariable('sectors')},
